...
sites=read.table(paste0(args[1],'_binding_sites_80pc_affinity.bed'), sep='\t',header=F,stringsAsFactors=F)
...
for(i in c(1:to)){
    ...
    print(head(sub))
    write.table(sub, paste0('quintile_',i,'_',args[1],'_',args[2],'.bed'),sep='\t',
